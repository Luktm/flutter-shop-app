...
class NotificationPlugin {
  ...
  // Recommended use "showNotification" method! 
  // "showDialyAtTime", "showWeeklyAtTime", "repeatNotification", "showSchudeuleNotification" and "showNotificationAttachment" were optional
  ...
  Future<void> showDialyAtTime() async {
  ...
  Future<void> showSchudeuleNotification() async {
  ...
  Future<void> showNotificationAttachment() async {
    var attachmentPicturePath = await _downloadAndSaveFile("https://via.placeholder.com/800x200", "attachment_img.jpg");
    ...
    await flutterLocalNotificationsPlugin.show(0, "title with attachment", "body with attachement", notificationDetails);
  }
